...
int main()
{
    ...
    for(int i = 0; i<5; i++) //Assigns values for Quadrant 2
    {
        for(int j = 0; j<5; j++)
        {
            ludo[i][j] = "0";
    ...
    for(int i = 8; i<13; i++) //Assigns values for Quadrant 3
    {
        for(int j = 0; j<5; j++)
        {
            ludo[i][j] = "0";
    ...
    for(int i = 0; i<5; i++) //Assigns values for Quadrant 1
    {
        for(int j = 8; j<13; j++)
        {
            ludo[i][j] = "0";
    ...
    for(int i = 8; i<13; i++) //Assigns values for Quadrant 4
    {
        for(int j = 8; j<13; j++)
        {
            ludo[i][j] = "0";
    ...
    PrintBoard(ludo, posi, posj); //Prints empty board
